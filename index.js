...
const isValidDirection = (direction, velocityX, velocityY) => {
  return (direction.x !== -velocityX || direction.y !== -velocityY);
}

const changeDirection = e => {
  const direction = directions[e.key];
  if (direction && isValidDirection(direction, velocityX, velocityY)) {
